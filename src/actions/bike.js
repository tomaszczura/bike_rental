...
export const FETCH_BIKE_START = 'BIKE/FETCH_BIKE_START';
export const FETCH_BIKE_SUCCESS = 'BIKE/FETCH_BIKE_SUCCESS';
export const FETCH_BIKE_ERROR = 'BIKE/FETCH_BIKE_ERROR';

export const FETCH_BIKES_BOOKINGS_START = 'BIKE/FETCH_BIKES_BOOKINGS_START';
export const FETCH_BIKES_BOOKINGS_SUCCESS = 'BIKE/FETCH_BIKES_BOOKINGS_SUCCESS';
export const FETCH_BIKES_BOOKINGS_ERROR = 'BIKE/FETCH_BIKES_BOOKINGS_ERROR';
